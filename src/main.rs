...
use bevy_ggrs::*;
use bevy_matchbox::{matchbox_socket::{PeerId}, prelude::SingleChannel};
...
fn wait_for_players(mut commands: Commands, mut socket: ResMut<bevy_matchbox::MatchboxSocket<SingleChannel>>) {
...
fn start_matchbox_socket(mut commands: Commands) {
    ...
    commands.insert_resource(bevy_matchbox::MatchboxSocket::new_ggrs(room_url));
}